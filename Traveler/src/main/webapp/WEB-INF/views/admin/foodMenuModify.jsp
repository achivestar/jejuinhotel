...
<body>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
			...
			<div class="row" id="anch">
				...
				<div class="col-md-12">
						<form name="dataForm" id="dataForm" method="post" action="/admin/foodMenuUpdate" enctype="multipart/form-data">
							<div class="form-group">
							    <label for="title">메뉴이름</label>
							    <input type="text" class="form-control" id="title" name="title" value="${foodmenuvo.title }">
							</div>
							<div class="form-group">
								 <label for="content">메뉴소개</label>
								<textarea class="form-control"  name="content" id="content" rows="3">${foodmenuvo.content}</textarea>
							</div>
							...
							<div class="form-group">
							    ...
							    <select  class="form-control" id="division" name="division">
							      ...
							      <option value="food" <c:if test="${foodmenuvo.division eq 'food'}">selected</c:if> >일반음식</option>
							      <option value="beverage" <c:if test="${foodmenuvo.division eq 'beverage'}">selected</c:if>>Coffee/Dessert</option>
							    </select>
							</div>
							...
							<div class="form-group">
							    ...
							    <br>
							    <img src="/resources/foodmenufileupload/${foodmenuvo.idx}/${foodmenuvo.savedFileName}" class="img-thumbnail" alt="..." style="width:200px;height:auto">
							    <br>
							    <input type="file" class="form-control-file" id="input_file" name="file"  value="${foodmenuvo.savedFileName}" >

							</div>

						  <br>
						  <input type="hidden" name="idx" value="${foodmenuvo.idx }" />
  ...
  <script>
	...
	$("#delete").click(function(){
		 ...
		 var ans = window.confirm("메뉴 소개글을 삭제하시겠습니까?");
		...
		if(ans) {
				$.ajax({
					...
					processData: false, 
					contentType: false, 	
					url: "/admin/foodMenuDelete", 
					data: form,
					dataType: 'html',
					success: function(data){
						alert("메뉴 소개글이 삭제 되었습니다.");
						location.href="/admin/foodmenu"
					}
					,beforeSend : function(){
